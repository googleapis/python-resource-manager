...
class TestProject(unittest.TestCase):
    ...
    def test_constructor_explicit(self):
        ...
        DISPLAY_NAME = "name"
        LABELS = {"foo": "bar"}
        project = self._make_one(PROJECT_ID, client, name=DISPLAY_NAME, labels=LABELS)
        self.assertEqual(project.project_id, PROJECT_ID)
        self.assertEqual(project._client, client)
    ...
    def test_create(self):
        ...
        expected_request = {
            "method": "POST",
            "data": {"projectId": PROJECT_ID, "labels": {}, "name": None},
            "path": "/projects",
        }
    ...
    def test_delete_with_reload_data(self):
        ...
        # NOTE: data is not in the request since a DELETE request.
        expected_delete_request = {"method": "DELETE", "path": project.path}
