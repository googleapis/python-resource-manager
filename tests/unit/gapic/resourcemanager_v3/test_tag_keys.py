...
def test_list_tag_keys(
    transport: str = "grpc", request_type=tag_keys.ListTagKeysRequest
):
...
def test_create_tag_key(
    transport: str = "grpc", request_type=tag_keys.CreateTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_update_tag_key(
    transport: str = "grpc", request_type=tag_keys.UpdateTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
...
def test_delete_tag_key(
    transport: str = "grpc", request_type=tag_keys.DeleteTagKeyRequest
):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
