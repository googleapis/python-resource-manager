...
def test__get_default_mtls_endpoint():
    ...
    assert (
        TagBindingsClient._get_default_mtls_endpoint(api_endpoint) == api_mtls_endpoint
    )
    assert (
        TagBindingsClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        TagBindingsClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        TagBindingsClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
...
@mock.patch.object(
    TagBindingsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TagBindingsClient)
)
@mock.patch.object(
    TagBindingsAsyncClient,
    "DEFAULT_ENDPOINT",
    modify_default_endpoint(TagBindingsAsyncClient),
)
def test_tag_bindings_client_client_options(
    client_class, transport_class, transport_name
):
...
def test_tag_bindings_client_mtls_env_auto(
    client_class, transport_class, transport_name, use_client_cert_env
):
...
def test_tag_bindings_client_client_options_scopes(
    client_class, transport_class, transport_name
):
...
def test_tag_bindings_client_client_options_credentials_file(
    client_class, transport_class, transport_name
):
...
def test_tag_bindings_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.resourcemanager_v3.services.tag_bindings.transports.TagBindingsGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_tag_bindings(
    transport: str = "grpc", request_type=tag_bindings.ListTagBindingsRequest
):
    ...
    with mock.patch.object(
        type(client.transport.list_tag_bindings), "__call__"
    ) as call:
...
def test_create_tag_binding(
    transport: str = "grpc", request_type=tag_bindings.CreateTagBindingRequest
):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.create_tag_binding), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
...
def test_delete_tag_binding(
    transport: str = "grpc", request_type=tag_bindings.DeleteTagBindingRequest
):
    client = TagBindingsClient(
        credentials=ga_credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.delete_tag_binding), "__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name="operations/spam")
...
def test_tag_bindings_base_transport():
    ...
    with mock.patch(
        "google.cloud.resourcemanager_v3.services.tag_bindings.transports.TagBindingsTransport.__init__"
    ) as Transport:
