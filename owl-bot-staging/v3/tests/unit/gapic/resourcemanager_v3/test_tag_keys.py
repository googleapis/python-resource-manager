...
async def test_list_tag_keys_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_tag_keys(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_tag_key_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["tag_key"] = {'name': 'name_value', 'parent': 'parent_value', 'short_name': 'short_name_value', 'namespaced_name': 'namespaced_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value'}
    request = request_type(**request_init)
...
def test_update_tag_key_rest(request_type):
    ...
    request_init["tag_key"] = {'name': 'tagKeys/sample1', 'parent': 'parent_value', 'short_name': 'short_name_value', 'namespaced_name': 'namespaced_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'etag': 'etag_value'}
    request = request_type(**request_init)
