...
from google.cloud.resourcemanager_v3.services.tag_keys.transports.base import _GOOGLE_AUTH_VERSION
...
def test_tag_keys_client_service_account_always_use_jwt(client_class):
...
def test_tag_keys_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_tag_keys_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_list_tag_keys(transport: str = 'grpc', request_type=tag_keys.ListTagKeysRequest):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_tag_keys_from_dict():
    test_list_tag_keys(request_type=dict)
...
def test_get_tag_key(transport: str = 'grpc', request_type=tag_keys.GetTagKeyRequest):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_tag_key_from_dict():
    test_get_tag_key(request_type=dict)
...
def test_create_tag_key(transport: str = 'grpc', request_type=tag_keys.CreateTagKeyRequest):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_tag_key_from_dict():
    test_create_tag_key(request_type=dict)
...
def test_create_tag_key_flattened():
    ...
    with mock.patch.object(
        ...
        assert len(call.mock_calls) == 1
        _, args, _ = call.mock_calls[0]
        assert args[0].tag_key == tag_keys.TagKey(name='name_value')
...
def test_update_tag_key(transport: str = 'grpc', request_type=tag_keys.UpdateTagKeyRequest):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_tag_key_from_dict():
    test_update_tag_key(request_type=dict)
...
def test_update_tag_key_field_headers():
    ...
    assert (
        'x-goog-request-params',
        'tag_key.name=tag_key.name/value',
    ) in kw['metadata']
...
def test_delete_tag_key(transport: str = 'grpc', request_type=tag_keys.DeleteTagKeyRequest):
    client = TagKeysClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_tag_key_from_dict():
    test_delete_tag_key(request_type=dict)
...
def test_tag_keys_base_transport_with_credentials_file_old_google_auth():
    # Instantiate the base transport with a credentials file
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.resourcemanager_v3.services.tag_keys.transports.TagKeysTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        load_creds.return_value = (ga_credentials.AnonymousCredentials(), None)
...
@requires_google_auth_lt_1_25_0
def test_tag_keys_auth_adc_old_google_auth():
    # If no credentials are provided, we should use ADC credentials.
    with mock.patch.object(google.auth, 'default', autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        TagKeysClient()
...
@requires_google_auth_lt_1_25_0
def test_tag_keys_transport_auth_adc_old_google_auth(transport_class):
    # If credentials and host are not provided, the transport class should use
    # ADC credentials.
    with mock.patch.object(google.auth, "default", autospec=True) as adc:
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
