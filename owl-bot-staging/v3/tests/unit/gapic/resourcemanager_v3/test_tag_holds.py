...
from google.cloud.resourcemanager_v3.services.tag_holds import TagHoldsAsyncClient
...
from google.cloud.resourcemanager_v3.services.tag_holds import transports
...
@pytest.mark.parametrize("client_class", [
    TagHoldsClient, TagHoldsAsyncClient
])
@mock.patch.object(TagHoldsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TagHoldsClient))
@mock.patch.object(TagHoldsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(TagHoldsAsyncClient))
...
def test_create_tag_hold(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.create_tag_hold),
            '__call__') as call:
...
def test_delete_tag_hold(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_tag_hold),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_tag_holds(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_tag_holds),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_tag_holds_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, tag_holds.TagHold)
                   for i in results)
...
def test_create_tag_hold_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TagHoldsRestInterceptor, "post_create_tag_hold") as post, \
         mock.patch.object(transports.TagHoldsRestInterceptor, "pre_create_tag_hold") as pre:
...
def test_delete_tag_hold_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TagHoldsRestInterceptor, "post_delete_tag_hold") as post, \
         mock.patch.object(transports.TagHoldsRestInterceptor, "pre_delete_tag_hold") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_tag_holds_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TagHoldsRestInterceptor, "post_list_tag_holds") as post, \
         mock.patch.object(transports.TagHoldsRestInterceptor, "pre_list_tag_holds") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_tag_holds_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.TagHoldsGrpcTransport, transports.TagHoldsGrpcAsyncIOTransport])
def test_tag_holds_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.TagHoldsGrpcTransport, transports.TagHoldsGrpcAsyncIOTransport])
def test_tag_holds_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
