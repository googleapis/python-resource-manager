...
@pytest.mark.parametrize("client_class", [
    ProjectsClient, ProjectsAsyncClient
])
@mock.patch.object(ProjectsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProjectsClient))
@mock.patch.object(ProjectsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ProjectsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (ProjectsAsyncClient, transports.ProjectsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_projects_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
async def test_list_projects_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_projects(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_search_projects_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.search_projects(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ProjectsRestInterceptor, "post_get_project") as post, \
...
def test_get_project_rest_bad_request(transport: str = 'rest', request_type=projects.GetProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v3/{name=projects/*}" % client.transport._host, args[1])
...
def test_list_projects_rest_required_fields(request_type=projects.ListProjectsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_projects._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_projects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_list_projects") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_list_projects") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = projects.ListProjectsResponse.to_json(projects.ListProjectsResponse())
        ...
        client.list_projects(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_projects_rest_bad_request(transport: str = 'rest', request_type=projects.ListProjectsRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_projects_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/projects" % client.transport._host, args[1])
...
def test_search_projects_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_search_projects") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_search_projects") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = projects.SearchProjectsResponse.to_json(projects.SearchProjectsResponse())
        ...
        client.search_projects(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_search_projects_rest_bad_request(transport: str = 'rest', request_type=projects.SearchProjectsRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_search_projects_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/projects:search" % client.transport._host, args[1])
...
def test_create_project_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {}
    request_init["project"] = {'name': 'name_value', 'parent': 'parent_value', 'project_id': 'project_id_value', 'state': 1, 'display_name': 'display_name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'etag': 'etag_value', 'labels': {}}
    request = request_type(**request_init)
...
def test_create_project_rest_required_fields(request_type=projects.CreateProjectRequest):
    transport_class = transports.ProjectsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_project._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ProjectsRestInterceptor, "post_create_project") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_create_project") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_project(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_project_rest_bad_request(transport: str = 'rest', request_type=projects.CreateProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_project_rest(request_type):
    ...
    request_init["project"] = {'name': 'projects/sample1', 'parent': 'parent_value', 'project_id': 'project_id_value', 'state': 1, 'display_name': 'display_name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'delete_time': {}, 'etag': 'etag_value', 'labels': {}}
    request = request_type(**request_init)
...
def test_update_project_rest_required_fields(request_type=projects.UpdateProjectRequest):
    transport_class = transports.ProjectsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_project._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_update_project") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_update_project") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_project(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_project_rest_bad_request(transport: str = 'rest', request_type=projects.UpdateProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{project.name=projects/*}" % client.transport._host, args[1])
...
def test_move_project_rest_required_fields(request_type=projects.MoveProjectRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).move_project._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_move_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_move_project") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_move_project") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.move_project(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_move_project_rest_bad_request(transport: str = 'rest', request_type=projects.MoveProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_move_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*}:move" % client.transport._host, args[1])
...
def test_delete_project_rest_required_fields(request_type=projects.DeleteProjectRequest):
    transport_class = transports.ProjectsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_project._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_delete_project") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_delete_project") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_project(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_project_rest_bad_request(transport: str = 'rest', request_type=projects.DeleteProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undelete_project_rest_required_fields(request_type=projects.UndeleteProjectRequest):
    transport_class = transports.ProjectsRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).undelete_project._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_undelete_project_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_undelete_project") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_undelete_project") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = projects.UndeleteProjectRequest.pb(projects.UndeleteProjectRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.undelete_project(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_undelete_project_rest_bad_request(transport: str = 'rest', request_type=projects.UndeleteProjectRequest):
    client = ProjectsClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_undelete_project_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{name=projects/*}:undelete" % client.transport._host, args[1])
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{resource=projects/*}:getIamPolicy" % client.transport._host, args[1])
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{resource=projects/*}:setIamPolicy" % client.transport._host, args[1])
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ProjectsRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.ProjectsRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v3/{resource=projects/*}:testIamPermissions" % client.transport._host, args[1])
