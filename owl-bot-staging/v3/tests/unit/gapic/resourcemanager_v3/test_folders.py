...
@pytest.mark.parametrize("client_class,transport_name", [
    (FoldersClient, "grpc"),
    (FoldersAsyncClient, "grpc_asyncio"),
    (FoldersClient, "rest"),
])
...
@pytest.mark.parametrize("transport_class,transport_name", [
    ...
    (transports.FoldersRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (FoldersClient, transports.FoldersRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (FoldersClient, transports.FoldersRestTransport, "rest", "true"),
    (FoldersClient, transports.FoldersRestTransport, "rest", "false"),
])
@mock.patch.object(FoldersClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FoldersClient))
@mock.patch.object(FoldersAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FoldersAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    FoldersClient, FoldersAsyncClient
])
@mock.patch.object(FoldersClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FoldersClient))
@mock.patch.object(FoldersAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(FoldersAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (FoldersClient, transports.FoldersGrpcTransport, "grpc", grpc_helpers),
    (FoldersAsyncClient, transports.FoldersGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (FoldersClient, transports.FoldersRestTransport, "rest", None),
])
...
async def test_search_folders_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.search_folders(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_folder_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = folders.Folder.pb(return_value)
...
def test_get_folder_rest_interceptors(null_interceptor):
    transport = transports.FoldersRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.FoldersRestInterceptor(),
        )
    client = FoldersClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FoldersRestInterceptor, "post_get_folder") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_get_folder") as pre:
...
def test_list_folders_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = folders.ListFoldersResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_folders_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FoldersRestInterceptor, "post_list_folders") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_list_folders") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_search_folders_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = folders.SearchFoldersResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_search_folders_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FoldersRestInterceptor, "post_search_folders") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_search_folders") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.FoldersRestInterceptor, "post_create_folder") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_create_folder") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.FoldersRestInterceptor, "post_update_folder") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_update_folder") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_move_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.FoldersRestInterceptor, "post_move_folder") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_move_folder") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.FoldersRestInterceptor, "post_delete_folder") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_delete_folder") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_undelete_folder_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.FoldersRestInterceptor, "post_undelete_folder") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_undelete_folder") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FoldersRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FoldersRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.FoldersRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.FoldersRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_transport_kind(transport_name):
    transport = FoldersClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_folders_client_transport_session_collision(transport_name):
    ...
    client1 = FoldersClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = FoldersClient(
        credentials=creds2,
        transport=transport_name,
    )
...
@pytest.mark.parametrize("client_class,transport_class", [
    (FoldersClient, transports.FoldersGrpcTransport),
    (FoldersAsyncClient, transports.FoldersGrpcAsyncIOTransport),
])
