...
class TagValuesAsyncClient:
    ...
    get_transport_class = functools.partial(type(TagValuesClient).get_transport_class, type(TagValuesClient))
    ...
    async def list_tag_values(self,
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_namespaced_tag_value(self,
    ...
    async def create_tag_value(self,
    ...
    async def update_tag_value(self,
    ...
    async def delete_tag_value(self,
