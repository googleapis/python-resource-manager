...
from .base import OrganizationsTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class OrganizationsRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_iam_policy(self, response: policy_pb2.Policy) -> policy_pb2.Policy:
        ...
        """
        return response
    def pre_get_organization(self, request: organizations.GetOrganizationRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[organizations.GetOrganizationRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_organization(self, response: organizations.Organization) -> organizations.Organization:
        ...
        """
        return response
    def pre_search_organizations(self, request: organizations.SearchOrganizationsRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[organizations.SearchOrganizationsRequest, Sequence[Tuple[str, str]]]:
