...
from .transports.base import TagHoldsTransport, DEFAULT_CLIENT_INFO
...
class TagHoldsAsyncClient:
    ...
    get_transport_class = functools.partial(type(TagHoldsClient).get_transport_class, type(TagHoldsClient))
    ...
    async def create_tag_hold(self,
    ...
    async def delete_tag_hold(self,
