...
from .base import TagKeysTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class TagKeysRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_tag_key(self, request: tag_keys.CreateTagKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_keys.CreateTagKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_tag_key(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_tag_key(self, request: tag_keys.DeleteTagKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_keys.DeleteTagKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_iam_policy(self, response: policy_pb2.Policy) -> policy_pb2.Policy:
        ...
        """
        return response
    def pre_get_tag_key(self, request: tag_keys.GetTagKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_keys.GetTagKeyRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_tag_key(self, response: tag_keys.TagKey) -> tag_keys.TagKey:
        ...
        """
        return response
    def pre_list_tag_keys(self, request: tag_keys.ListTagKeysRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_keys.ListTagKeysRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_test_iam_permissions(self, response: iam_policy_pb2.TestIamPermissionsResponse) -> iam_policy_pb2.TestIamPermissionsResponse:
        ...
        """
        return response
    def pre_update_tag_key(self, request: tag_keys.UpdateTagKeyRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[tag_keys.UpdateTagKeyRequest, Sequence[Tuple[str, str]]]:
